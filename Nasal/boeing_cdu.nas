...
var key = func(v) {
		...
		if (serviceable == 1){
			if (v == "LSK1L"){
				...
				if (cduDisplay == "RTE1_LEGS"){
					if (cduInput == "DELETE"){
						...
						selected_wp = wpCurr;
						cduInput = getprop("/autopilot/route-manager/route/wp["~wpCurr~"]/id");
					}
					else{
			...
			if (v == "LSK1R"){
				...
				if (cduDisplay == "RTE1_LEGS"){
					setprop("/autopilot/route-manager/route/wp["~wpCurr~"]/altitude-ft",cduInput);
					if (substr(cduInput,0,2) == "FL"){
						setprop("/autopilot/route-manager/route/wp["~wpCurr~"]/altitude-ft",substr(cduInput,2)*100);
					}
					cduInput = "";
				}
			}
			if (v == "LSK2L"){
				...
				if (cduDisplay == "NAV_RAD"){
					var actv = getprop("/instrumentation/nav[0]/frequencies/selected-mhz");
					...
					setprop("/instrumentation/nav[0]/frequencies/standby-mhz",actv);
				}
				...
				if (cduDisplay == "RTE1_LEGS"){
					if (cduInput == "DELETE"){
						...
						selected_wp = wp1;
						cduInput = getprop("/autopilot/route-manager/route/wp["~wp1~"]/id");
					}
					else{
			...
			if (v == "LSK2R"){
				...
				if (cduDisplay == "NAV_RAD"){
					var actv = getprop("/instrumentation/nav[1]/frequencies/selected-mhz");
					...
					setprop("/instrumentation/nav[1]/frequencies/standby-mhz",actv);
				}
				else if (cduDisplay == "MENU"){
					eicasDisplay = "EICAS_MODES";
				}
				else if (cduDisplay == "RTE1_LEGS"){
					setprop("/autopilot/route-manager/route/wp["~wp1~"]/altitude-ft",cduInput);
					if (substr(cduInput,0,2) == "FL"){
						setprop("/autopilot/route-manager/route/wp["~wp1~"]/altitude-ft",substr(cduInput,2)*100);
					}
					cduInput = "";
				}
			}
			if (v == "LSK3L"){
				...
				if (cduDisplay == "RTE1_LEGS"){
					if (cduInput == "DELETE"){
						...
						selected_wp = wp2;
						cduInput = getprop("/autopilot/route-manager/route/wp["~wp2~"]/id");
					}
					else{
			...
			if (v == "LSK3R"){
				if (cduDisplay == "RTE1_LEGS"){
					setprop("/autopilot/route-manager/route/wp["~wp2~"]/altitude-ft",cduInput);
					if (substr(cduInput,0,2) == "FL"){
						setprop("/autopilot/route-manager/route/wp["~wp2~"]/altitude-ft",substr(cduInput,2)*100);
					}
					cduInput = "";
				}
				if (cduDisplay == "NAV_RAD"){
			...
			if (v == "LSK4L"){
				...
				if (cduDisplay == "RTE1_LEGS"){
					if (cduInput == "DELETE"){
						...
						selected_wp = wp3;
						cduInput = getprop("/autopilot/route-manager/route/wp["~wp3~"]/id");
					}
					else{
				...
				if (cduDisplay == "NAV_RAD"){
					setprop("/instrumentation/adf[0]/frequencies/standby-khz",cduInput);
					cduInput = "";
				}
			}
			if (v == "LSK4R"){
				if (cduDisplay == "RTE1_LEGS"){
					setprop("/autopilot/route-manager/route/wp["~wp3~"]/altitude-ft",cduInput);
					if (substr(cduInput,0,2) == "FL"){
						setprop("/autopilot/route-manager/route/wp["~wp3~"]/altitude-ft",substr(cduInput,2)*100);
					}
					cduInput = "";
				}
				if (cduDisplay == "NAV_RAD"){
			...
			if (v == "LSK5L"){
				...
				if (cduDisplay == "RTE1_LEGS"){
					if (cduInput == "DELETE"){
						...
						selected_wp = wp4;
						cduInput = getprop("/autopilot/route-manager/route/wp["~wp4~"]/id");
					}
					else{
				...
				if (cduDisplay == "NAV_RAD"){
					var actv = getprop("/instrumentation/adf[0]/frequencies/selected-khz");
					var stby = getprop("/instrumentation/adf[0]/frequencies/standby-khz");
					setprop("/instrumentation/adf[0]/frequencies/selected-khz",stby);
					setprop("/instrumentation/adf[0]/frequencies/standby-khz",actv);
				}
			}
			if (v == "LSK5R"){
				if (cduDisplay == "RTE1_LEGS"){
					setprop("/autopilot/route-manager/route/wp["~wp4~"]/altitude-ft",cduInput);
					if (substr(cduInput,0,2) == "FL"){
						setprop("/autopilot/route-manager/route/wp["~wp4~"]/altitude-ft",substr(cduInput,2)*100);
					}
					cduInput = "";
				}
				if (cduDisplay == "NAV_RAD"){
					var actv = getprop("/instrumentation/adf[1]/frequencies/selected-khz");
					var stby = getprop("/instrumentation/adf[1]/frequencies/standby-khz");
					setprop("/instrumentation/adf[1]/frequencies/selected-khz",stby);
					setprop("/instrumentation/adf[1]/frequencies/standby-khz",actv);
				}
			}
			if (v == "LSK6L"){
				if (cduDisplay == "INIT_REF"){
			...
			if (v == "exec") {
				if (cduDisplay == "RTE1_LEGS" and selected_wp > 0) {
					setprop("autopilot/route-manager/current-wp",selected_wp);
					cduInput = sprintf("%f,%f", getprop("instrumentation/gps/indicated-longitude-deg"), getprop("instrumentation/gps/indicated-latitude-deg"));
					setprop("/autopilot/route-manager/input","@INSERT"~selected_wp~":"~cduInput);
					cduInput = "";
					selected_wp = -1;
				}
			}
...
var cdu = func{
		...
		if (display == "NAV_RAD") {
			...
			line1lt = "VOR L";
			line1l = sprintf("%3.2f", getprop("/instrumentation/nav[0]/frequencies/selected-mhz-fmt"));
			line1c = sprintf("%3.2f", getprop("/instrumentation/nav[0]/frequencies/standby-mhz-fmt"))~"   "~sprintf("%3.2f", getprop("/instrumentation/nav[1]/frequencies/standby-mhz-fmt"));
			line1rt = "VOR R";
			line1r = sprintf("%3.2f", getprop("/instrumentation/nav[1]/frequencies/selected-mhz-fmt"));
			line2l = "   <->";
			line2lt = "ACTIVE";
			...
			line3lt = "CRS";
			line3ct = "RADIAL";
			line3c = sprintf("%3.2f", getprop("/instrumentation/nav[0]/radials/selected-deg"))~"   "~sprintf("%3.2f", getprop("/instrumentation/nav[1]/radials/selected-deg"));
			line3rt = "CRS";
			line4lt = "ADF L";
			line4l = sprintf("%3.2f", getprop("/instrumentation/adf[0]/frequencies/selected-khz"));
			line4c = sprintf("%3.2f", getprop("/instrumentation/adf[0]/frequencies/standby-khz"))~"   "~sprintf("%3.2f", getprop("/instrumentation/adf[1]/frequencies/standby-khz"));
			line4rt = "ADF R";
		...
		if (display == "RTE1_LEGS") {
			...
			if (getprop("/autopilot/route-manager/route/wp["~wpCurr~"]/id") != nil){
				line1lt = sprintf("%3.0f", getprop("/autopilot/route-manager/route/wp["~wpCurr~"]/leg-bearing-true-deg"));
				line1l = getprop("/autopilot/route-manager/route/wp["~wpCurr~"]/id");
			...
			if (getprop("/autopilot/route-manager/route/wp["~wp1~"]/id") != nil){
				if (getprop("/autopilot/route-manager/route/wp["~wp1~"]/leg-bearing-true-deg") != nil){
					line2lt = sprintf("%3.0f", getprop("/autopilot/route-manager/route/wp["~wp1~"]/leg-bearing-true-deg"));
				}
				line2l = getprop("/autopilot/route-manager/route/wp["~wp1~"]/id");
				if (getprop("/autopilot/route-manager/route/wp["~wp1~"]/leg-distance-nm") != nil){
					line3ct = sprintf("%3.0f", getprop("/autopilot/route-manager/route/wp["~wp1~"]/leg-distance-nm"))~" NM";
				}
			...
			if (getprop("/autopilot/route-manager/route/wp["~wp2~"]/id") != nil){
				if (getprop("/autopilot/route-manager/route/wp["~wp2~"]/leg-bearing-true-deg") != nil){
					line3lt = sprintf("%3.0f", getprop("/autopilot/route-manager/route/wp["~wp2~"]/leg-bearing-true-deg"));
				}
				line3l = getprop("/autopilot/route-manager/route/wp["~wp2~"]/id");
				if (getprop("/autopilot/route-manager/route/wp["~wp2~"]/leg-distance-nm") != nil){
					line4ct = sprintf("%3.0f", getprop("/autopilot/route-manager/route/wp["~wp2~"]/leg-distance-nm"))~" NM";
				}
				line3r = sprintf("%5.0f", getprop("/autopilot/route-manager/route/wp["~wp2~"]/altitude-ft"));
				if (getprop("/autopilot/route-manager/route/wp["~wp2~"]/speed-kts") != nil){
					line3r = getprop("/autopilot/route-manager/route/wp["~wp2~"]/speed-kts")~"/"~sprintf("%5.0f", getprop("/autopilot/route-manager/route/wp["~wp2~"]/altitude-ft"));;
					}
				}
			if (getprop("/autopilot/route-manager/route/wp["~wp3~"]/id") != nil){
				if (getprop("/autopilot/route-manager/route/wp["~wp3~"]/leg-bearing-true-deg") != nil){
					line4lt = sprintf("%3.0f", getprop("/autopilot/route-manager/route/wp["~wp3~"]/leg-bearing-true-deg"));
				}
				line4l = getprop("/autopilot/route-manager/route/wp["~wp3~"]/id");
				if (getprop("/autopilot/route-manager/route/wp["~wp3~"]/leg-distance-nm") != nil){
					line5ct = sprintf("%3.0f", getprop("/autopilot/route-manager/route/wp["~wp3~"]/leg-distance-nm"))~" NM";
				}
				line4r = sprintf("%5.0f", getprop("/autopilot/route-manager/route/wp["~wp3~"]/altitude-ft"));
				if (getprop("/autopilot/route-manager/route/wp["~wp3~"]/speed-kts") != nil){
					line4r = getprop("/autopilot/route-manager/route/wp["~wp3~"]/speed-kts")~"/"~sprintf("%5.0f", getprop("/autopilot/route-manager/route/wp["~wp3~"]/altitude-ft"));
					}
				}
			if (getprop("/autopilot/route-manager/route/wp["~wp4~"]/id") != nil){
				if (getprop("/autopilot/route-manager/route/wp["~wp4~"]/leg-bearing-true-deg") != nil){
					line5lt = sprintf("%3.0f", getprop("/autopilot/route-manager/route/wp["~wp4~"]/leg-bearing-true-deg"));
				}
