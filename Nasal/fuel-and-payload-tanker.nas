...
var standard_load = func{
  ...
  if(!st){
		...
		setprop("/fdm/jsbsim/inertia/pointmass-weight-lbs[1]", 1429.0);
		setprop("/fdm/jsbsim/inertia/pointmass-weight-lbs[2]", 4713.0);
		setprop("/fdm/jsbsim/inertia/pointmass-weight-lbs[3]", 9529.0);
		setprop("/fdm/jsbsim/inertia/pointmass-weight-lbs[4]", 1005.0);
		setprop("/fdm/jsbsim/inertia/pointmass-weight-lbs[5]", 4104.0);
		setprop("/fdm/jsbsim/inertia/pointmass-weight-lbs[6]", 5532.0);
